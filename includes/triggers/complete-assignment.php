...
class AutomatorWP_WPLMS_Complete_Assignment extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a assignment', 'automatorwp-wplms-integration' ),
            'select_option'     => __( 'User <strong>completes</strong> a assignment', 'automatorwp-wplms-integration' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Assignment:', 'automatorwp-wplms-integration' ),
                    'option_none_label' => __( 'any assignment', 'automatorwp-wplms-integration' ),
