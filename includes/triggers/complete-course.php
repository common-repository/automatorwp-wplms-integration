...
class AutomatorWP_WPLMS_Complete_Course extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a course', 'automatorwp-wplms-integration' ),
            'select_option'     => __( 'User <strong>completes</strong> a course', 'automatorwp-wplms-integration' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Course:', 'automatorwp-wplms-integration' ),
                    'option_none_label' => __( 'any course', 'automatorwp-wplms-integration' ),
                    'post_type' => 'course'
                ) ),
