...
class AutomatorWP_WPLMS_Complete_Unit extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a unit', 'automatorwp-wplms-integration' ),
            'select_option'     => __( 'User completes <strong>a unit</strong>', 'automatorwp-wplms-integration' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Unit:', 'automatorwp-wplms-integration' ),
                    'option_none_label' => __( 'any unit', 'automatorwp-wplms-integration' ),
                    'post_type' => 'unit'
                ) ),
